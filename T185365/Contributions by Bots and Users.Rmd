...
media_type_plot <- bot_by_mediatype_omitbitmap %>%
...
ggsave("bot_by_mediatype_omitbitmap.png", plot = media_type_plot)
media_type_plot
```
...
### Total number of newly uploaded (non-Cumulative) file contributions by month
```{r}
bot_by_month %>%
